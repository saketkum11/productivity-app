...
const EditModal = ({ task, setEditModalFlag }) => {
  ...
  return (
    <div>
      <div className="fixed top-0 bottom-0 left-0 right-0 opacity-40 bg-slate-400 "></div>
      <div className="fixed z-20 top-0 bottom-0 left-0 right-0  flex justify-center items-center">
